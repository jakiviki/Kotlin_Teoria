...
fun main() {
    ...
    var listEmpty = emptyList<String>()
    println(listEmpty.joinToString())

    var lisEmpty2 = listOf<String>()
    println(lisEmpty2.joinToString())
    println("diferencia entre listof y emptylis listof: $lisEmpty2")
