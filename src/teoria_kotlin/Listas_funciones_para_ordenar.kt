...
fun main() {
    ...
    val sumalist = lista.sum()
    println(sumalist)

    // par el promedio de una lista
    val promedio = lista.average()
    println("promedio de Int: $promedio")
    ...
    val multiplos = lista.sortedBy { numero -> numero < 5 }
    println(multiplos + "mayores de 5 con sortedBy")
    // ordena por multiplo o por condicion al final de la lista
    val multiplosSort = lista.sortedBy { numero -> numero%5 == 0 }
    println(multiplosSort + "multiplos con sortedBy")
    ...
    val filtrados = lista.filter { numero -> numero > 8 }
